...
check_openscad() {
    OPENSCAD=$(find_openscad) || {
        echo "Error: OpenSCAD executable not found."
        echo ""
        echo "Please ensure OpenSCAD is already installed and available as 'openscad' in your PATH,"
        echo "or located in a common location (e.g. /Applications/OpenSCAD.app on macOS)."
        exit 1
    }
    export OPENSCAD
}
